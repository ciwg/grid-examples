...
- `moks route policy show` and `moks route policy set ...` control planner preferences for route types and roles
...
Source: `DI-rutom`; `DI-ruvot`; `DI-lafek`; `DI-fotav`; `DI-pabut`; `DI-matek`.
