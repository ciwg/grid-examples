...
Status: active
Decision: Implement the first procedures package as a first-party built-in domain egg that composes the shared knowledge and runs families while also declaring procedure-specific families.
Intent: Prove that business behavior can live above the shared eggs instead of collapsing back into the basket core.
...
- package docs showing how a real egg is structured

## Why

This package should become the first serious proof that ex6 can carry ex5-like
business behavior as a modular egg.
