...
// Intent: Extract the durable record signing identity into the reusable
// PromiseGrid record substrate so signed frozen-family artifacts no longer live
// only as ex5-specific service internals. Source: DI-ragiv
