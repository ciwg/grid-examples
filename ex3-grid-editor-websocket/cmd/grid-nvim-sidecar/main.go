...
func main() {
	// Intent: Point the copied sidecar at ex3's default relay URL so Neovim can
	// attach to the new example without manual port overrides. Source: DI-vatub
	var relayURL = flag.String("relay", "http://127.0.0.1:7025", "grid relay base URL")
	flag.Parse()
