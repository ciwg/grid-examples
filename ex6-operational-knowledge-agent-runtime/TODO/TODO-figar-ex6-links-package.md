...
Status: active
Decision: Implement the first links package as a first-party built-in package with one typed-link family while the installed-package mutation contract remains shallow.
