# Operational Knowledge Agent Runtime (OKAR) --- Initial Codex Design Specification

> **Working name:** Operational Knowledge Agent Runtime (OKAR)
>
> **Historical codename:** EX6

## Executive Summary

Design OKAR as a completely new, standalone, independently
