...
import "github.com/computerscienceiscool/grid-examples/ex2-grid-editor/protocol"
...
func NewMessage(documentID string, content string, lamport uint64, author string, embodiment string, previousCID string) (Message, error) {
